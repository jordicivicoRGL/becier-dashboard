...
2. **Lee `clients/diagonal-cq.md`** para cargar el contexto completo de la clínica.
...
**Aviso de canibalización — OBLIGATORIO:** Antes de continuar, pregunta a Jordi si ya existe una página en el sitio que trabaje esta keyword o un tratamiento muy similar. Si ya existe, crear otra página haría que compitan entre sí en Google, lo que perjudica la posición de ambas. Si Jordi confirma que ya existe una página, recomienda optimizar la existente en lugar de crear una nueva (Modo 2).
...
```
H1 — Para páginas de tratamiento: "[Keyword principal] en Córdoba" — la keyword va primero, sin adornos editoriales. Ejemplo correcto: "Liposucción de Abdomen en Córdoba". Ejemplo incorrecto: "Liposucción: en qué consiste, técnicas y resultados". **Excepción:** si la keyword ya contiene "córdoba" o "Córdoba", no añadir la ciudad de nuevo — evita el H1 redundante tipo "Liposucción Córdoba en Córdoba".
...
#### 3. Borrador del texto

Redacta el texto completo siguiendo la estructura del paso 2 y las reglas del paso 4.

**Etiquetas de heading — OBLIGATORIO en Modo 1:** Al entregar el texto final en el chat, cada heading debe ir precedido de su etiqueta de nivel en negrita: `**[H1]**`, `**[H2]**`, `**[H3]**`. Esto facilita la implementación en WordPress sin ambigüedad. Ejemplo: `**[H2]** ¿Qué es la lipoescultura y cuándo está indicada?`
...
### Ronda 4 — Revisor Ortotipográfico

**Rol:** Garantizar que el texto publicado no contiene ningún error de ortografía, acentuación ni puntuación. Un error en contenido médico publicado daña la credibilidad de la clínica y el E-E-A-T.

**Qué revisa:**
- **Tildes y acentos**: repasa cada palabra. Toda palabra que lleve tilde en español debe llevarla sin excepción: análisis, posición, médico, cirugía, también, así, más, además, etc.
- **Letra ñ**: ninguna palabra con ñ puede escribirse sin ella: señal, año, diseño, Córdoba no aplica pero sí: campaña, daño, etc.
- **Puntuación**: comas, puntos y puntos y coma coherentes. Especial atención en listas de bullets y párrafos de conclusiones
- **Coherencia tipográfica**: comillas («» o "" de forma uniforme), guiones largos (—) y cortos (-) usados correctamente
- **Lectura final de calidad**: si alguna frase suena torpe, redundante o poco profesional, reescríbela

**Output del experto:**
```
[REVISOR ORTOTIPOGRÁFICO]
Correcciones aplicadas:
• [corrección 1]
• [corrección 2]
...
...
Tras las cuatro rondas, entrega el texto final con la nota:

> **Revisado por:** Médico revisor · Copywriter médico · Experto SEO · Revisor Ortotipográfico
...
- [ ] Etiquetas `[H1]` / `[H2]` / `[H3]` en negrita antes de cada heading (Modo 1: en el chat; Modo 2: en el .docx)
